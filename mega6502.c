...
/* 12K RAM */
uint8_t ram[0x3000] __attribute__((section(".ram")));


/* pins used on ATmega1284P */
...
/* PHI0 */
#define PHI0 PD7
#define PORT_PHI0 PORTD
#define PIN_PHI0 PIND
#define DDR_PHI0 DDRD
...
/* the last (10th) AVR cycle of a 6502 clock phase is used to toggle phi0 */
...
int main()
{
	...
	asm volatile (
		...
		"	; RAM address? (AH < 0x30)                     (true: 2, false: 3)  \n\t"
		...
		"	; 4 AVR cycles left for 1MHz 6502 clock        (4)                  \n\t"
		"	nop                                                                 \n\t"
		"	nop                                                                 \n\t"
		"	nop                                                                 \n\t"
		"	nop                                                                 \n\t"
		...
		"	; 1 AVR cycle left for 1MHz 6502 clock         (1)                  \n\t"
		"	nop                                                                 \n\t"
