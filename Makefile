...
reset:
	avrdude -p atmega2560 -c wiring -P $(SERIAL_DEV) -b 115200


upload: $(TARGET).bin
	-kill `pgrep -f "picocom -b 600 --imap lfcrlf $(SERIAL_DEV)"`
	sleep 1
	avrdude -p atmega2560 -c wiring -P $(SERIAL_DEV) -b 115200 -D -U flash:w:$(TARGET).bin:r
...
dump_flash:
	avrdude -p atmega2560 -c wiring -P $(SERIAL_DEV) -b 115200 -U flash:r:$(TARGET).bin:r
